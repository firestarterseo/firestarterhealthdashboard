...
// Filters out obviously bot-filled form submissions. Two distinct spam patterns
// seen in the wild: (1) a scraper leaves the literal field-label text behind
// ("Name*", "Email*") — a near-certain signal on its own — or (2) a bot fills
// garbage into every field (single-letter name, "@@" for an email, an all-zeros
// phone number). For pattern 2 we require at least two red flags together, so a
// real person who just skips the phone field isn't wrongly excluded.
